...
// clear-default
// ---------------------------------------------------------------------------
// Usage: amanda clear-default
// ---------------------------------------------------------------------------
void cmd_clear_default(HttpClient& /*client*/, AmandaConfig& cfg, const Args& /*args*/) {
    cfg.default_tray = "";
    save_config(cfg);
    std::cout << "Default tray cleared; future puts will use the system tray.\n";
}
